...
public class AgendaEventos {
    ...
    public void obterProximoEvento(){
        ...
        Map<LocalDate, Evento> eventosTreeMap = new TreeMap<>(eventosMap);//Eventos organizados em forma crescente
    ...
    public static void main(String[] args) {
        ...
        agendaEventos.adicionarEvento(LocalDate.of(2023, 10, 9), "Evento 2", "Atracao 2");
